...
class RealmAdapter extends RecyclerView.Adapter<RealmAdapter.ViewHolder> {
    ...
    public interface Listener {
        void onRowItemClicked( RealmObject realmObject, Field field);
    }
    ...
    public RealmAdapter(Context context, AbstractList<? extends RealmObject> realmObjects,
                        List<Field> fieldList, Listener listener) {
    ...
    private View.OnClickListener createClickListener(final RealmObject realmObject,final Field field) {
